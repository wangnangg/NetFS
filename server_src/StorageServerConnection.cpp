...
StorageServerConnection::StorageServerConnection(const Poco::Net::StreamSocket& socket):Poco::Net::TCPServerConnection(socket){
...
void StorageServerConnection::run(){
  ...
  std::string response = " * Storage Server received message from address: " + 
    this->socket().peerAddress().toString() + "\r\n" +
    " * This StorageServer will reply with the requested file... eventually \r\n" +
    " *\r\n" +
    " *\r\n" +
    " * Seeks are bad.... \r\n";
